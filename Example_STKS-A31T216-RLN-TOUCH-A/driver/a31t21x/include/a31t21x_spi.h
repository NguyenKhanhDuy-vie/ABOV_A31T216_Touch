...
* @brief        A31T21x SPI Driver Header
*
...
enum spi_sync_mode
{
    SPI_SYNC_MODE_CPOL_0_CPHA_0 = 0,        /**< polarity 0, phase 0 */
    SPI_SYNC_MODE_CPOL_0_CPHA_1 = 1,        /**< polarity 0, phase 1 */
    SPI_SYNC_MODE_CPOL_1_CPHA_0 = 2,        /**< polarity 1, phase 0 */
    SPI_SYNC_MODE_CPOL_1_CPHA_1 = 3,        /**< polarity 1, phase 1 */
};
